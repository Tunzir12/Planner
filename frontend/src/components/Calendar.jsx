...
const Calendar = () => {
  ...
  const handleEventClick = clickInfo => {
    ...
    const firestoreEvent = events.find(
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      const eventData = {
        ...
        backgroundColor:
          currentEvent.backgroundColor || (currentEvent.allDay ? '#3b82f6' : '#60a5fa'),
      };
  ...
  const renderEventContent = eventInfo => {
    return (
      <div
        className={`p-1 w-full rounded-lg ${eventInfo.event.allDay ? 'bg-blue-600' : 'bg-blue-500'}`}
      >
        <b>{eventInfo.event.title}</b>
        {eventInfo.event.extendedProps.description && (
          <p className='text-xs'>{eventInfo.event.extendedProps.description}</p>
        )}
        {!eventInfo.event.allDay && <p className='text-xs'>{eventInfo.timeText}</p>}
      </div>
    );
  };
                        ...
                        <div className='grid grid-cols-1 gap-4'>
                          <div>
                            ...
                            <input
                              ...
                              required
                              value={
                                currentEvent.start ? formatDateForInput(currentEvent.start) : ''
                              }
                          ...
                          <div>
                            ...
                            <input
                              ...
                              required
                              value={
                                currentEvent.start ? formatTimeForInput(currentEvent.start) : ''
                              }
