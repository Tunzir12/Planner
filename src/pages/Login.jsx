    ...
    <div className='flex h-screen bg-gray-800'>
      <div className='w-full max-w-xs m-auto rounded p-5 bg-gray-100 shadow-xl'>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            className='w-full bg-gray-700 hover:bg-gray-900 text-white font-bold py-2 px-4 mb-6 rounded'
            type='submit'
          >
            Log In{' '}
          </button>
          ...
          <Link className='text-sm float-right hover:text-gray-700' to='/register'>
            Create account
          </Link>
        </form>
      </div>
